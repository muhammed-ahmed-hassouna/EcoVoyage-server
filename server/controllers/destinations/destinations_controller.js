const destinationsModel = require("../../Models/destinations/destinations_model");
...
const updateDestinations = async (req, res) => {
  ...
  try {
    ...
    const result = await destinationsModel.updateDestinations(
      destinations_id,
      destinationData
    );
...
const markDestinationsAsDeleted = async (req, res) => {
  const destinations_id = req.params.id;
  try {
    const result = await destinationsModel.markDestinationsAsDeleted(
      destinations_id
    );
...
const getDestinationsPaginated = async (req, res) => {
  try {
    ...
    const result = await destinationsModel.getDestinationsPaginated(
      page,
      pageSize,
      search
    );

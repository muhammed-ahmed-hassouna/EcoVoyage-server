const packagesModel = require("../../Models/packages/package_model");
...
const updatePackages = async (req, res) => {
  ...
  try {
    ...
    const result = await packagesModel.updatePackages(
      packages_id,
      packagesData
    );
...
const addCommentPac = async (req, res) => {
  ...
  try {
    const commentResult = await packagesModel.addCommentPac(
      packages_id,
      user_id,
      comment_text
    );
...
const BookPackage = async (req, res) => {
  ...
  try {
    const result = await packagesModel.BookPackage(
      packages_id,
      cost,
      user_id,
      address,
...
const getPackagesPaginated = async (req, res) => {
  try {
    ...
    const result = await packagesModel.getPackagesPaginated(
      page,
      pageSize,
      search
    );

...
const packagesController = require("../../controllers/packages/packages_controller");
const router = Router();
...
router.put(
  "/markPackagesAsDeleted/:id",
  verifyJWT.authorize([2]),
  packagesController.markPackagesAsDeleted
);
...
router.post(
  ...
  packagesController.addCommentPac
);

router.get(
  "/getPackagesWithComments/:id",
  packagesController.getPackagesWithComments
);
